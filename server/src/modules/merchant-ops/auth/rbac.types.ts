...
export const ALL_AUDIT_ACTIONS: ReadonlyArray<AuditAction> = [
  ...
  'ORDER_READ', 'ORDER_CHECKOUT', 'ORDER_ADD_ITEM', 'ORDER_MARK_SERVED', 'ORDER_DELETE_DRAFT', 'ORDER_REFUND',
  'MENU_ITEM_UPDATE',
  'TABLE_READ', 'TABLE_UPDATE', 'TABLE_QRCODE_GENERATE',
  'REFUND_READ',
  'STATISTICS_READ',
  'STORE_SETTINGS_UPDATE', 'STORE_SMTP_UPDATE',
  'NOTIF_ROBOT_UPDATE', 'NOTIF_TEMPLATE_UPDATE', 'NOTIF_EMAIL_TEST',
